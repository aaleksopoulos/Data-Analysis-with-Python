...
def draw_bar_plot():
    ...
    df_bar['month'] = pd.to_datetime(df_bar.index).month_name()
    
    
    df_bar = df_bar.groupby(by=['year', 'month'])['value'].agg('mean').round(2)
...
def draw_box_plot():
    ...
    fig, (ax1, ax2) = plt.subplots(nrows=1, ncols=2, figsize=(45,15))
